...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_lam_weights="train_UpLAM_MSE_TV_L1_16bands.pth",
        ...
        # OUTPUT PATHS
        # extracted features UpLAM 16 log spaced bands
        feat_label_dir="/scratch/ssd1/spatial_locata_LAM_feats_4chan_table2_wideband_log",
        ...
        f_pool_size=[2],      # CNN frequency pooling, length of list = number of CNN layers, list value = pooling per layer
    ...
    if '2020' in params['dataset_dir']:
        ...
        params['unique_classes'] = 13
    elif 'STARSS23_audio_only' in params['dataset_dir'] or 'spatial_seld_lam' in params['dataset_dir']: # Using LOCATA or other dataset with only one class
