...
class ComputeSELDResults(object):
    ...
    def get_SELD_Results(self, pred_files_path, is_jackknife=False):
        ...
        if is_jackknife:
            ...
            return [ER, conf_interval[0]], [F, conf_interval[1]], [LE, conf_interval[2]], [LR, conf_interval[3]], [seld_scr, conf_interval[4]], [classwise_results, np.array(conf_interval)[5:].reshape(5,-1,2) if len(classwise_results) else []]
...
if __name__ == "__main__":
    pred_output_format_files = "/scratch/data/repos/Classical-Sound-Source-Localization-Algorithms-in-Spherical-Domain/output_music_locata_kmeans"#'results/3_11553814_dev_split0_multiaccdoa_foa_20220429142557_test' # Path of the DCASEoutput format files
