...
img_indx = 10 # time index image to study (e.g. 10 == 10th ms)
freq_indx = 8 # frequency index to study
bands = np.arange(10)
...
for rir_tokens in rirs_list:
    ...
    for clip in audio_clips:
        ...
        max_indices = np.argpartition(apgd_map, -30)[-30:]
...
ax.set_title('Mean variance across 10 music tracks w.r.t distance')
ax.set_xlabel('Distance (m)')
ax.set_ylabel('DoA Intensity Variance (dispersion)')

fig.savefig("./figures/distance_analysis.png")
